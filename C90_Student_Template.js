...
function car1_up()
{
	...
	{
		car1_y = car1_y - 10;
		console.log("when up arrow key is pressed, x = " + car1_x + "l y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}    
...
function car2_up()
{
	...
	{
		car2_y = car2_y - 10;
		console.log("when w key is pressed, x = " + car2_x + "l y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}    
...
function car2_down()
{
	...
	{
		car2_y = car2_y + 10;
		console.log("when s key is pressed, x = " + car2_x + "l y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}    
...
function car2_left()
{
	...
	{
		car2_x = car2_x - 10;
		console.log("when a key is pressed, x = " + car2_x + "l y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}    
...
function car2_right()
{
	...
	{
		car2_x = car2_x + 10;
		console.log("when d key is pressed, x = " + car2_x + "l y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}    
